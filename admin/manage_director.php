...
<p class="font-weight-bold ml-2" style="color:rgb(127,255,212);">Manage Director</p>
...
$sql="select * from director inner join add_movies on director.movie_id=add_movies.mid order by dir_id desc";
...
<td><img src='<?=$row["director_image"]?>' style="height:80px;width:60px;"></td>
<td>
    <a href="edit_director.php?id=<?=$row["dir_id"]?>" class="mana btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_director.php?id=<?=$row["dir_id"]?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
