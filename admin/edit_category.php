...
-->
 <!--hello hi how are you -->
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Edit Category</p>
...
include('../db.php');
$cid=$_GET["id"];
$sql11="select name from category where cid=$cid";
$result11=mysqli_query($con,$sql11);
$row11=mysqli_fetch_assoc($result11);
?>
<div class="col-md-6 my-2">
    <input type="text" class="form-control form-control-sm" value="<?=$row11['name']?>" name="name" placeholder="Enter Category name" id="email">
</div>
<input type="hidden" value="<?=$cid?>" name="id">
<div class="col-md-6 offset-md-6 text-danger"><p id="fnameerr"></p></div>
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="edit_category">Update Category</button>
</div>
</form>
</div>
  </div>
