...
<p class="font-weight-bold ml-2" style="color:rgb(127,255,212);">Manage Users</p>
...
<td><?=$row["gender"]?></td>
<td>
    <a href="delete_users.php?id=<?=$row["id"]?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
