...
-->
 <!--hello hi how are you -->
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Add Director</p>
...
<div class="custom-file">
    <input type="file" class="custom-file-input" id="customFile" name="director_image" required>
...
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="add_director">Add Director</button>
<button type="button" onclick="window.location.replace('manage_director.php');" class=" border-0 ml-3">Manage Director</button>
</div>
</form>
</div>
...
messages:{
    ...
    director_image:"Please choose director image"
}
});
