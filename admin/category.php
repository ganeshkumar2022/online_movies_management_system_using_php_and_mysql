...
-->
 <!--hello hi how are you -->
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Add Category</p>
...
<div class="col-md-6 my-2">
    <input type="text" class="form-control form-control-sm" name="name" placeholder="Enter Category name" id="email">
</div>
<div class="col-md-6 offset-md-6 text-danger"><p id="fnameerr"></p></div>
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="add_category">Add Category</button>
</div>
</form>
</div>
  </div>
