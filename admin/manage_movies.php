...
<p class="font-weight-bold ml-2" style="color:rgb(127,255,212);">Manage Movies</p>
...
$sql="select * from add_movies order by mid desc";
...
<td><img src='<?=$row["movie_image"]?>' style="height:80px;width:60px;"></td>
<td>
    <a href="edit_movie.php?id=<?=$row["mid"]?>" class="mana btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_movie.php?id=<?=$row["mid"]?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
