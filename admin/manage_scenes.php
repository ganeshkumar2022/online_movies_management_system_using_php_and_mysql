...
$sql="select * from movie_scenes inner join add_movies on movie_scenes.movies_id=add_movies.mid order by scenes_id desc";
...
<td><img src='<?=$row["scene_image"]?>' style="height:80px;width:100px;"></td>
<td>
<a href="delete_scenes.php?id=<?=$row["scenes_id"]?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
