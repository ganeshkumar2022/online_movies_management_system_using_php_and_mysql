...
<p class="font-weight-bold ml-2" style="color:rgb(127,255,212);">Manage Subcategory</p>
...
<td><?=$row["screading_time"]?></td>
<td>
    <a href="edit_sub_category.php?id=<?=$row["scid"]?>" class="mana btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_sub_category.php?id=<?=$row["scid"]?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
