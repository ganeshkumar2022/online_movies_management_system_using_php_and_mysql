...
-->
 <!--hello hi how are you -->
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Add Movie scenes</p>
...
<div class="custom-file">
    <input type="file" class="custom-file-input" id="customFile" name="scene_image" required>
    <label class="custom-file-label" for="customFile">Movie scene image</label>
  </div>
  <script>
...
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="add_scene">Add Scene</button>
<button type="button" onclick="window.location.replace('manage_scenes.php');" class=" border-0 ml-3">Manage Scenes</button>
</div>
</form>
</div>
...
<div class="col-md-5 my-4">
  <img src="../images/scenes.jpg" class="img-fluid" style="height:360px;">
  </div>
  </div>
...
messages:{
    ...
    scene_image:"choose movie scene image"
}
});
