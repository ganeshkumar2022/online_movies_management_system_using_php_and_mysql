...
-->
 <!--hello hi how are you -->
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Add Stars</p>
...
if(mysqli_num_rows($resultc)>0)
{
    ...
    {
        ?>
        <option value="<?=$rowc['mid']?>"><?=$rowc["movie_name"]?></option>
        <?php
    }
}
?>
...
<div class="col-md-6 my-2">
<input type="text" name="star_name" class="form-control" placeholder="Enter Star name">
</div>
...
<div class="custom-file">
    <input type="file" class="custom-file-input" id="customFile" name="star_image" required>
    <label class="custom-file-label" for="customFile">Choose Star image</label>
  </div>
  <script>
...
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="add_star">Add Star</button>
<button type="button" onclick="window.location.replace('manage_star.php');" class=" border-0 ml-3">Manage Star</button>
</div>
</form>
</div>
...
<div class="col-md-5 my-4">
  <img src="stars.jpg" class="img-fluid" style="height:360px;">
  </div>
  </div>
...
messages:{
    ...
    star_name:"Please enter star name",
    star_image:"Please choose star image"
}
});
