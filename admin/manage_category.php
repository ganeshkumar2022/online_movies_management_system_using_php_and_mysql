...
<p class="font-weight-bold ml-2" style="color:rgb(127,255,212);">Manage Category</p>
...
<td>
    <a href="edit_category.php?id=<?=$row['cid']?>" class="mana btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_category.php?id=<?=$row['cid']?>" class="mana btn btn-danger btn-sm"><i class="fa-solid fa-xmark"></i></a>
</td>
</tr>
<?php
$i++;
