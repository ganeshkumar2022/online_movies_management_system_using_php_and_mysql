...
include('db.php');
$id=$_GET["id"];
$sql="select * from star where star_id=$id";
...
?>
  ...
  <p class="font-weight-bold ml-4" style="color:rgb(127,255,212);">Edit Star</p>
<p id="prof_upd_success" class=" text-success text-center"></p>
<p id="prof_upd_danger" class=" text-danger text-center"></p>
  <div class="row p-4">
<div class="col-md-12 mb-3">
<center>
<img src='<?=$row["star_image"]?>' style="height:200px;width:150px;">
</center>
</div>
...
<div class="col-md-6 my-2">
<input type="text" name="star_name" class="form-control" value="<?=$row['star_name']?>" placeholder="Enter Star name">
</div>
...
<div class="custom-file">
    <input type="file" class="custom-file-input" id="customFile" name="star_image">
...
<div class="form-group">
<button type="submit" class=" border-0 ml-3" name="edit_star">Update Star</button>
</div>
</form>
</div>
