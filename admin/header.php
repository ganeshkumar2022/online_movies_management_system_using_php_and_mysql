...
<nav class="navbar navbar-expand-md myheadernav">
  ...
  <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link  font-weight-bold ahov" href="category.php">CATEGORY</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold ahov" href="subcategory.php">SUB CATEGORY</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold ahov" href="add_movies.php">ADD MOVIES</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold ahov" href="manage_movies.php">MANAGE MOVIES</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold ahov" href="manage_users.php">MANAGE USERS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold ahov" href="others.php">OTHERS</a>
      </li>
